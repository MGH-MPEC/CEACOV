...
DAILY_OUTCOME_STRS = ["day#"] +  list(DISEASE_STATE_STRS) + [f"cumulative {state}" for state in DISEASE_PROGRESSIONS_STRS] + ["new infections", "cumulative infections", "dead", "exposures"] + list(INTERVENTION_STRS) + ["tests"]
